...
$lang = array_merge($lang, array(
	...
	'RULE_REMOVED_MESSAGE'				=> 'PMルール によって 1 件のプライベートメッセージが削除されました',
	'RULE_REMOVED_MESSAGES'				=> 'PMルール によって %d 件のプライベートメッセージが削除されました',
	...
	'UCP_WELCOME'					=> 'ユーザーコントロールパネル （ユーザーCP） へようこそ。ユーザーCP ではプロフィール、ユーザー設定、ウォッチ中のフォーラムまたはトピックについて確認、閲覧、編集を行うことができます。他のユーザーに （管理人が許可していれば） プライベートメッセージを送ることもできます。また、グローバル告知トピックがあればこのページで表示されますので未読の場合は必ず確認するようにしてください。',
