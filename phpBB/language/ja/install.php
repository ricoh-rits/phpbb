...
$lang = array_merge($lang, array(
	...
	'COLLIDING_USERNAMES_FOUND'	=> '旧掲示板システムのデータ内に、データをコンバートすると （データをクリーニングすると） 競合してしまうユーザー名が存在します。データコンバートする前にそれら競合するユーザーを削除するかリネームしてユーザー名が競合しないようにしてください。',
	...
	'FTP_PATH'					=> 'FTP パス',
	'FTP_PATH_EXPLAIN'			=> 'サーバにおけるあなたのルートディレクトリから見た phpBB3 ルートディレクトリへの相対パスです。例: <samp>htdocs/phpBB3/</samp>.',
	'FTP_UPLOAD'				=> 'アップロード',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		...
		<p>下のボタンをクリックすれば Administration Control Panel (AdminCP) へ入室できます。そこで phpBB3 がどのような機能を備えているか確認すると良いでしょう。ヘルプ情報はこちらをご覧ください： <a href="https://www.phpbb.com/support/documentation/3.0/">Documentation</a>, <a href="%3$s">README</a>, <a href="https://www.phpbb.com/community/viewforum.php?f=46">Support Forums</a>。</p><p><strong>install ディレクトリを削除すれば一般ユーザーが掲示板にアクセスできるようになります。install ディレクトリがそのままの状態で存在している間は AdminCP ページのみしかアクセスすることはできません。</strong>',
...
-------------
	...
	'PCRE_UTF_SUPPORT_EXPLAIN'		=> 'もし PCRE（Perl互換正規表現）関数が UTF-8 によるパターン文字列を取り扱えない場合、 phpBB3 は動作<strong>しません</strong>。PHP の PCRE拡張モジュール のバージョンが古い場合、この症状が起こります。',
...
-------------
	...
	'SUPPORT_BODY'				=> 'phpBB3 の最新安定バージョンに関するサポートは無料で提供されています。サポートの内容は:</p><ul><li>インストール</li><li>各種設定</li><li>技術的な質問</li><li>ソフトウェアのバグに関する問題</li><li>リリース候補（RC）バージョンから最新安定バージョンへのアップデート</li><li>phpBB2.0.x から phpBB3 へのデータコンバート</li><li>他の掲示板ソフトウェアから phpBB3 へのデータコンバート (<a href="https://www.phpbb.com/community/viewforum.php?f=65">Convertors Forum</a> をご覧ください）</li></ul><p>もし phpBB3 のベータバージョンをまだ利用している場合、phpBB3 の最新安定バージョンを新しくインストールすることを強く勧めます。</p><h2>MOD / スタイル</h2><p>MOD については <a href="https://www.phpbb.com/community/viewforum.php?f=81">Modifications Forum</a> の関連するトピックに質問・投稿してください。<br />スタイル、テンプレート、イメージセットについては、<a href="https://www.phpbb.com/community/viewforum.php?f=80">Styles Forum</a> の関連するトピックに質問・投稿してください。<br /><br />もし特定のバージョンについて質問したい場合、そのバージョン専用のトピックがありますのでそちらにご投稿ください。</p><h2>サポート</h2><p><a href="https://www.phpbb.com/community/viewtopic.php?f=14&amp;t=571070">The phpBB Welcome Package</a><br /><a href="https://www.phpbb.com/support/">Support Section</a><br /><a href="https://www.phpbb.com/support/documentation/3.0/quickstart/">Quick Start Guide</a><br /><br />最新ニュースと最新リリースのメールを購読するには <a href="https://www.phpbb.com/support/">subscribe to our mailing list</a> にてメールアドレスを入力し送信してください。<br /><br />',
